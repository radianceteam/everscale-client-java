...
[![SDK version](https://img.shields.io/badge/Ever%20SDK%20version-1.37.0-green)](https://github.com/tonlabs/TON-SDK/tree/1.37.0)
...
```
    $ mvn test
```
- If succeed, you can find "everscale-client-binding-1.37.0-jar-with-dependencies.jar" file located under ${Project_basedir}/binding/target
