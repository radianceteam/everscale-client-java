...
[![SDK version](https://img.shields.io/badge/TON%20SDK%20version-1.17.0-green)](https://github.com/tonlabs/TON-SDK/tree/1.17.0)
...
```
    $ mvn test
```
- If succeed, you can find "ton-client-binding-1.17.0-jar-with-dependencies.jar" file located under ${Project_basedir}/binding/target
