...
public class AbiTest extends TestBase {
    ...
    public void encode_v2() throws Exception {
        ...
        Abi.ResultOfEncodeMessage unsigned = abiModule.encodeMessage(abi, null, deploySet, deployCallSet, new Abi.Signer.External(keys.getPublic()), null).get();
        ...
        Abi.ResultOfEncodeMessage signed2 = abiModule.encodeMessage(abi, null, deploySet, deployCallSet, new Abi.Signer.Keys(keys), null).get();
        assertEquals(signed.getMessage(), "");
        ...
        Abi.ResultOfEncodeMessage unsigned2 = abiModule.encodeMessage(abi, address, null, runCallSet, new Abi.Signer.External(keys.getPublic()), null).get();
        ...
        Abi.ResultOfEncodeMessage signed4 = abiModule.encodeMessage(abi, address, null, runCallSet, new Abi.Signer.Keys(keys), null).get();
        ...
        Abi.ResultOfEncodeMessage noPubkey = abiModule.encodeMessage(abi, address, null, runCallSet, Abi.Signer.None, null).get();
