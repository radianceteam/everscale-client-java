...
pub mod client {
    ...
    use jni::sys::{jint};
    use jni::objects::{JClass, JString, JValue, JMethodID};
    use std::sync::{Mutex};
    ...
    thread_local! (
        static THREAD_DATA: RefCell<ThreadData<'static>> = RefCell::new(ThreadData {
            class: None,
            callback_id: None,
        })
    );
    ...
    struct ThreadData<'a> {
        ...
        callback_id: Option<JMethodID<'a>>,
        //callback_id: Option<i32<'a>>,
    }
